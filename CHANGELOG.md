...
## 0.21.0 - 2026-08-24
### Support for Java 25 and Gradle 9

## 0.20.0 - 2026-05-19
### Added
- Support for SCM-Manager 4.x

## 0.19.3 - 2026-05-07
### Added
- Start parameter 'run-in-background' to run plugin in background
### Changed
- Use Maven Central repository directly instead of packages.scm-manager.org

## 0.19.2 - 2026-03-20
### Fixed
- Add switch to omit optional plugins in run command
...
## 0.19.1 - 2025-08-21
### Fixed
- Version check for core versions 4.x and bigger

## 0.19.0 - 2025-04-02
### Added
- Build support for queryable stores
